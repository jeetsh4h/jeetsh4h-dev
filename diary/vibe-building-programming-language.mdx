...
> Rely on technologies that are battle-tested with good documentation. One can definitely use LLM-assisted programming for a myriad of tasks but vibe-coding does not really allow for living on the razor's edge of rolling release.
