      ...
      <div className="max-w-3xl mx-auto px-6 py-12 md:py-20 space-y-16">
        ...
        <section className="space-y-6">
          <div className="flex justify-between items-start">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link href="/terminal">
                <Button className="hidden md:flex rounded-full h-9 bg-term-user text-term-bg hover:bg-term-user/90 hover:opacity-100 border-0 cursor-pointer">
        ...
        <section className="space-y-8">
          ...
          <div className="border-l-2 border-term-border/50 ml-2 space-y-10 pl-8 relative">
            ...
            {/* Compact Experience matching terminal style */}
            <div className="-mt-2 space-y-4">
              {EXPERIENCE.filter((e) => e.compact).map((job, i) => (
                ...
                >
                  {/* Small Dot matching terminal style (adjusted for page layout) */}
